...
it('pwan move rules, can move to steps from start - case 1', () => {
    const F2 = chess.allValidMoves("F2", state).sort() // trying to move white pice    
    ...
    const D7 = chess.allValidMoves("D7", {...state, turn: "black"}).sort()
